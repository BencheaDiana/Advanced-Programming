...
public class DroneExplorer {
    ...
    public static void main(String[] args) {
        ...
        List<Route> routes = Arrays.asList(
                new Route(locations[0], locations[3], 10.0, 0.9),
                new Route(locations[1], locations[11], 15.0, 0.7),
                new Route(locations[2], locations[9], 20.0, 0.5),
                new Route(locations[1], locations[10], 12.0, 0.8),
                new Route(locations[0], locations[5], 25.0, 0.6)
        );
